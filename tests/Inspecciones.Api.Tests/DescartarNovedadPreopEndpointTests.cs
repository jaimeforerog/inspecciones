...
/// contra la app real con Postgres en Testcontainers. Spec slice 1n Â§9.
///
/// Cubre:
/// Â§6.1  â€” happy path (200 OK + body NovedadId/MotivoDescarte/DescartadaPor/DescartadaEn).
/// Â§6.2  â€” PRE-2 inspecciÃ³n firmada â†’ 422 Unprocessable Entity.
/// Â§6.3  â€” PRE-2 inspecciÃ³n cancelada â†’ 422 Unprocessable Entity.
/// Â§6.4  â€” PRE-5 novedad ya descartada â†’ 422 Unprocessable Entity.
/// Â§6.5  â€” PRE-6 novedad ya convertida en hallazgo â†’ 422 Unprocessable Entity.
/// Â§6.7  â€” PRE-4 capability "ejecutar-inspeccion" ausente â†’ 403 Forbidden.
/// Â§6.8  â€” PRE-1 InspeccionId inexistente â†’ 404 Not Found.
...
public class DescartarNovedadPreopEndpointTests(InspeccionesAppFactory factory)
{
    ...
    /// <summary>
    /// Siembra una inspecciÃ³n firmada completa (para escenario PRE-2 ya firmada).
    /// </summary>
    ...
    /// <summary>
    /// Siembra inspecciÃ³n en ejecuciÃ³n + novedad ya descartada (para PRE-5 Â§6.4).
    /// </summary>
    ...
    /// <summary>
    /// Siembra inspecciÃ³n en ejecuciÃ³n + hallazgo con Origen=PreOperacional y
    /// NovedadPreopOrigenId=9001 (para PRE-6 Â§6.5 â€” INV-ND1).
    /// </summary>
    private async Task<Guid> SembrarInspeccionConHallazgoPreop(int equipoId, int novedadPreopOrigenId = 9001)
    {
        ...
        session.Events.Append(inspeccionId,
            new HallazgoRegistrado_v1(
                ...
                NovedadTecnica: "Fuga confirmada en sello hidrÃ¡ulico",
    ...
    /// <summary>
    /// Siembra inspecciÃ³n cancelada (para PRE-2 Â§6.3).
    /// </summary>
    ...
    public async Task POST_descartar_novedad_preop_happy_path_responde_200_OK()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.OK,
            "DescartarNovedadPreop devuelve 200 OK en el happy path (spec Â§9)");
        ...
        resultado.MotivoDescarte.Should().Contain("1",
            "el motivo autogenerado incluye el userId del tÃ©cnico (D-4)");
        resultado.MotivoDescarte.Should().Contain("UTC desde Inspecciones",
            "el motivo autogenerado usa la plantilla D-4 del spec Â§13");
        resultado.DescartadaEn.Should().BeCloseTo(CapturadoEn, precision: TimeSpan.FromMinutes(5));
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Â§6.2 PRE-2 â€” inspecciÃ³n firmada â†’ 422
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task POST_descartar_novedad_inspeccion_firmada_responde_422()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.UnprocessableEntity,
            "PRE-2: la inspecciÃ³n estÃ¡ Firmada â€” no se puede descartar novedades (spec Â§6.2)");
        var body = await response.Content.ReadFromJsonAsync<RespuestaError>();
        body!.CodigoError.Should().Be("PRE-2-ESTADO");
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Â§6.3 PRE-2 â€” inspecciÃ³n cancelada â†’ 422
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task POST_descartar_novedad_inspeccion_cancelada_responde_422()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.UnprocessableEntity,
            "PRE-2: la inspecciÃ³n estÃ¡ Cancelada â€” estado terminal (spec Â§6.3)");
        var body = await response.Content.ReadFromJsonAsync<RespuestaError>();
        body!.CodigoError.Should().Be("PRE-2-ESTADO");
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Â§6.4 PRE-5 â€” novedad ya descartada â†’ 422
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task POST_descartar_novedad_ya_descartada_responde_422_PRE5()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.UnprocessableEntity,
            "PRE-5: la novedad 9001 ya fue descartada en esta inspecciÃ³n (spec Â§6.4 / I4 / INV-ND1)");
        var body = await response.Content.ReadFromJsonAsync<RespuestaError>();
        body!.CodigoError.Should().Be("PRE-5-DESCARTADA");
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Â§6.5 PRE-6 â€” novedad ya convertida en hallazgo â†’ 422 (INV-ND1)
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task POST_descartar_novedad_ya_importada_como_hallazgo_responde_422_PRE6()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.UnprocessableEntity,
            "PRE-6 / INV-ND1: la novedad 9001 ya fue importada como hallazgo â€” exclusividad mutua (spec Â§6.5)");
        var body = await response.Content.ReadFromJsonAsync<RespuestaError>();
        body!.CodigoError.Should().Be("PRE-6-HALLAZGO");
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Â§6.7 PRE-4 â€” capability "ejecutar-inspeccion" ausente â†’ 403 Forbidden
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task POST_descartar_novedad_sin_capability_responde_403()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.Forbidden,
            "PRE-4: el endpoint debe rechazar con 403 si el tÃ©cnico no tiene capability 'ejecutar-inspeccion'");
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Â§6.8 PRE-1 â€” InspeccionId inexistente â†’ 404 Not Found
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task POST_descartar_novedad_inspeccion_inexistente_responde_404()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.NotFound,
            "PRE-1: la inspecciÃ³n no existe en el store (spec Â§6.8)");
    }
    ...
    public async Task POST_descartar_novedad_sin_header_X_Client_Command_Id_responde_400()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest,
            "El header X-Client-Command-Id es obligatorio (ADR-008 Â§9.16)");
        var body = await response.Content.ReadFromJsonAsync<RespuestaError>();
        body!.CodigoError.Should().Be("HEADER-REQUERIDO");
    }

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Idempotencia ADR-008 â€” mismo X-Client-Command-Id no duplica eventos (Skip)
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    [Fact(Skip = "Requiere Wolverine envelope storage con MessageId dedup. " +
                 ...
                 "con durable local queues. Ver spec Â§6.14 (idempotencia ADR-008 Â§9.16).")]
