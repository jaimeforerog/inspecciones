...
Fase 3 (Backend):             █████░░░░░░░░░░░░░░░  ~25% 🟡 (slices 1a-1f cerrados — 5/15 comandos del aggregate, 3.A setup base 4/5)
...
**Slices cerrados (Fase 3.B aggregate `Inspeccion`):**
...
1. **Continuar Fase 3** — slices restantes del aggregate `Inspeccion`: rama firma/dictamen (`Diagnostico`/`Dictamen`/`FirmarInspeccion` — 3.12 + 3.15 V-F1..V-F7), adjuntos (3.11), saga OT (3.13). Decisión 2026-05-05: arrancar también §3.B' monitoreo (comando `IniciarInspeccionMonitoreo` hermano).
